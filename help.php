						...
						<div class="panel-heading">
							<h4 class="panel-title">
								<a data-toggle="collapse" data-parent="#accordion" href="#collapse2">
									Como proceder para obter e instalar este website?        
								</a>
							</h4>
						</div>
						<div id="collapse2" class="panel-collapse collapse ">
							<div class="panel-body">
								Caso tenha interesse em utilizar esse sistema, envie uma solicitação por email para rsinoara@usp.br e solange@icmc.usp.br"    				
							</div>
						</div>
					</div>
				</div>
					...
					<div class="panel panel-default">
						...
						<div id="collapse5" class="panel-collapse collapse ">
							<div class="panel-body">
								...
								chances de terem o rótulo ‘Esporte’ sugerido.
							</div>
						</div>
					</div>
				</div> 					
